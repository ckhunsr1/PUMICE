...
<img src="https://github.com/ckhunsr1/PUMICE/blob/master/image/screenshot.png" width="400" height="790">
![Product Name Screen Shot][product-screenshot]{:height="20%" width="20%"}
