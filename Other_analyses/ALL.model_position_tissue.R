...
write.table(result, paste("/gpfs/group/dxl46/default/private/poom/GTEx/master_code/all/analyses/", tissue, "_", type, "_rel_pos.txt", sep =""),
               col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
write.table(count, paste("/gpfs/group/dxl46/default/private/poom/GTEx/master_code/all/analyses/", tissue, "_", type, "_snps_count.txt", sep =""),
               col.names = TRUE, row.names = FALSE, quote = FALSE, sep = "\t")
